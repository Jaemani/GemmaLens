...
export function GlobalStatusDock() {
  ...
  return (
    <aside className="fixed bottom-3 right-3 z-40 w-[min(280px,calc(100vw-1.5rem))] rounded-lg border border-line bg-panel/95 text-[11px] shadow-material backdrop-blur">
