...
PRESETS: dict[str, dict[str, str]] = {
    ...
    "gemma4-e2b-thinkpad": {
        "label": "Gemma 4 E2B (remote fp16)",
        "provider": "remote",
        "remote_gemma_model": "e2b",
        "size": "E2B",
        "speed": "Remote CPU",
        "description": "Use a private Gemma 4 E2B fp16 server configured by REMOTE_GEMMA_BASE_URL.",
    },
    "gemma4-e2b-thinkpad-q4": {
        "label": "Gemma 4 E2B (remote Q4)",
        "provider": "remote",
        "remote_gemma_model": "e2b-q4",
        "remote_gemma_base_url": "http://127.0.0.1:11445",
        "size": "E2B Q4",
        "speed": "Fast remote test",
        "description": "Quantized Q4_K_M llama.cpp server for fast functional testing.",
    },
    "gemma4-e4b-thinkpad": {
        "label": "Gemma 4 E4B (remote fp16)",
        "provider": "remote",
        "remote_gemma_model": "e4b",
        "size": "E4B",
        "speed": "Remote quality",
        "description": "Use a private Gemma 4 E4B fp16 server configured by REMOTE_GEMMA_BASE_URL.",
    },
}
